...
namespace STS_ESP.Helpers
{
    ...
    /// <summary>
    /// Cette classe est utile pour faire des operations dans le context et retourner des bool selon le type de reponse. 
    /// Elle permet donc de gerer les erreurs lors de l'ajout.
    /// </summary>
    public class DBHelper
    {
        public STSDbContext context = new STSDbContext();

        public DBHelper()
        {

        }
        public DBHelper(STSDbContext context1)
        {
            context = context1;
        }
        ...
        public static string isValidPhoneNumber(string phone)
        {
            ...
            if (phoneRegex.IsMatch(phone))
            {
                string formattedPhoneNumber =
                    phoneRegex.Replace(phone, "($1) $2-$3");
